...
# IP del host a eliminar (modificar según necesidad)
host_ip = "192.168.1.50"

# Eliminar host por IP
api_url = f"http://localhost:58000/api/v1/host/{host_ip}"
headers = {
...
print("Delete host request status:", resp.status_code)
print()
